/*
 ...
 Student Name: C. Rajeev Kumar
 Student ID: 21037897
 Class: C372-1D-E63C-A
...
app.get('/cart', [checkAuthenticated, checkUser], cartController.getCart, (req, res) => { res.render("netsQRHome") });
...
//Paypal Routes
// parse postparams sent in body in json format
